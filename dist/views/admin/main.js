...
var Api = /** @class */ (function () {
    ...
    Api.prototype.connectSocket = function (domain) {
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
            if (!domain) {
                ...
                switch (domain) {
                    case "auth":
                        _this.auth_socket = socket_io_client__WEBPACK_IMPORTED_MODULE_5__(_this.url + '/auth');
                        observer.next(_this.socket);
                        break;
                }
            }
    ...
    Api.prototype.disconnectSocket = function () {
        var _this = this;
        return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
    ...
    Api.prototype.socketConnected = function () {
        return this.socket.connected;
    };
    Api.prototype.send = function (message) {
        var _this = this;
        if (this.socket && !this.socket.connected) {
            return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
                _this.socket.emit(message.message, message.data, function (err, res) {
                    if (err)
                        observer.error(err);
                    else
                        observer.next(res);
    ...
    Api.prototype.get = function (endpoint, params, options) {
        ...
        if (params) {
            var p = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["URLSearchParams"]();
            for (var k in params) {
                p.set(k, params[k]);
            }
...
/*!*******************************!*\
  !*** ./src/app/app.module.ts ***!
  \*******************************/
/*! exports provided: providers, AppModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _views_signin_signin_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./views/signin/signin.component */ "./src/app/views/signin/signin.component.ts");
...
function providers() {
    return [
        _api_service__WEBPACK_IMPORTED_MODULE_14__["Api"],
        _storage_service__WEBPACK_IMPORTED_MODULE_16__["Storage"],
        _user_service__WEBPACK_IMPORTED_MODULE_15__["User"],
        {
...
var DefaultLayoutComponent = /** @class */ (function () {
    function DefaultLayoutComponent(router, user) {
        var _this = this;
        this.router = router;
        this.user = user;
    ...
    DefaultLayoutComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _user_service__WEBPACK_IMPORTED_MODULE_2__["User"]])
...
/***/ "./src/app/models/hybrid-message.ts":
/*!******************************************!*\
  !*** ./src/app/models/hybrid-message.ts ***!
  \******************************************/
/*! exports provided: HybridMessage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HybridMessage", function() { return HybridMessage; });
var HybridMessage = /** @class */ (function () {
    function HybridMessage(url, message, method, data, params, opts) {
        this.url = url;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _hybrid_message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hybrid-message */ "./src/app/models/hybrid-message.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HybridMessage", function() { return _hybrid_message__WEBPACK_IMPORTED_MODULE_0__["HybridMessage"]; });
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ngx-webstorage-service */ "./node_modules/ngx-webstorage-service/esm5/ngx-webstorage-service.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Storage = /** @class */ (function () {
    ...
    Storage = __decorate([
        ...
        __param(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_1__["SESSION_STORAGE"])),
...
var User = /** @class */ (function () {
     ...
     */
    User.prototype.genToken = function (username) {
...
var SigninComponent = /** @class */ (function () {
    function SigninComponent(api, fb, router, storage, user) {
        this.api = api;
        this.fb = fb;
        this.router = router;
        this.storage = storage;
    ...
    SigninComponent.prototype.buildSignInForm = function () {
        var _this = this;
        this.signIn = this.fb.group({
            username: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(4), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(10)]],
            password: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(4), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(20)]]
        });
        this.signIn.valueChanges
            .debounceTime(1000)
            .subscribe(function () { return _this.signInValueChanges(); });
    };
    SigninComponent.prototype.changedView = function (action) {
        this.action = action;
    };
    SigninComponent.prototype.checkKey = function (ev) {
        if (ev.which === 13)
            this.doSign();
    };
    SigninComponent.prototype.doSign = function () {
        var _this = this;
        this.user.signIn(this.signIn.value).subscribe(function (user) {
            ...
            _this.signInErrors.username = err.message;
        });
    };
    SigninComponent.prototype.signInValueChanges = function () {
        if (!this.signIn) {
            return;
        }
        for (var field in this.signInErrors) {
            this.signInErrors[field] = '';
            var control = this.signIn.get(field);
    ...
    SigninComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_api_service__WEBPACK_IMPORTED_MODULE_4__["Api"],
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            _storage_service__WEBPACK_IMPORTED_MODULE_5__["Storage"],
            _user_service__WEBPACK_IMPORTED_MODULE_6__["User"]])
    ], SigninComponent);
...
module.exports = __webpack_require__(/*! /root/code/mlipia/src/views/admin/src/main.ts */"./src/main.ts");
